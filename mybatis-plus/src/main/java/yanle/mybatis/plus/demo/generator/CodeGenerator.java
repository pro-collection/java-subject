...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        globalConfig.setAuthor("yanle");
        globalConfig.setOpen(false);
        autoGenerator.setGlobalConfig(globalConfig);

        // 配置数据源
        DataSourceConfig dataSourceConfig = new DataSourceConfig();
        dataSourceConfig.setUrl("jdbc:mysql://66.66.66.66:3306/mybatis_plus_demo?characterEncoding=utf-8&useSSL=false");
        ...
        packageConfig.setParent("yanle.mybatis.plugin.demo");
